...
using Trax.ApiServices.Web.Models;
using Trax.Models.Identity.Identity;

namespace Trax.ApiServices.Web.Providers
{
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            Trax.Models.Identity.Identity.ApplicationUser user = await userManager.FindAsync(context.UserName, context.Password);
